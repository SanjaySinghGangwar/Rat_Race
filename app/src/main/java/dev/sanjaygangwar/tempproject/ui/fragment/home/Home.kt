...
class Home : BaseFragment<HomeBinding>(HomeBinding::inflate), HomeAdapter.ItemListener, HomeAdapter.LongItemListener {
    ...
    override fun initAllComponents() {
        ...
        listOfApp.add(Items(name = "Naukri", isApp = true, link = "naukriApp.appModules.login", imageUrl = "https://play-lh.googleusercontent.com/76gEFhQto5xMHr2Qf8nWLvm1s0O60clhkwHvxQDSeI3hthf7Zs05JJQeyg5H347DGQ"))
        listOfApp.add(Items(name = "Instahire", isApp = false, link = "https://www.instahyre.com/candidate/opportunities/?matching=true", imageUrl = "https://static.instahyre.com/images/logos/logo.webp"))
        listOfApp.add(Items(name = "GlassDoor", isApp = true, link = "com.glassdoor.app", imageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiGXOdi2l8mOB1H7mZVSrh5HUuo_NqjNesWw&s"))
        ...
        listOfApp.add(Items(name = "WeekDay", isApp = false, link = "https://jobs.weekday.works/", imageUrl = "https://jobs.weekday.works/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.268caeb2.png&w=384&q=75"))
        ...
        listOfApp.add(Items(name = "StartUp Jobs", isApp = false, link = "https://startup.jobs/", imageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBi8NHnzhXiB3Fp6qSTKR_UBFWn5kS9z4FXw&s"))
        listOfApp.add(Items(name = "WellFounded", isApp = false, link = "https://angel.co/", imageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaNns9mjPx9NgfrCX2yubncghgP_urft_6OQ&s"))
        listOfApp.add(Items(name = "TopHire", isApp = false, link = "https://tophire.co/", imageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTa7NgQAy5myFT5oId-0Al68hHxmIm1xHp7bg&s"))
        listOfApp.add(Items(name = "Turing", isApp = false, link = "https://developers.turing.com/", imageUrl = "https://pbs.twimg.com/profile_images/1807814297461907464/xENEAURW_400x400.png"))
